...
$string['configenableinlineediting'] = 'If activated, user may reply to a forumspost inline, without leaving the forum main page';
$string['configenablequotedreplies'] = 'Quoted replies are enabled for users doing forum posts with the atto editor. Other editors are not supported';
...
$string['configquotestyle'] = 'Select the html markup used, when quoting messages';
...
$string['enableinlineediting'] = 'Enable inline editing';
$string['enablequotedreplies'] = 'Enable quoted replies';
...
$string['more'] = 'more';
$string['moreeditingoptions'] = 'More editing options';
$string['morereplyingoptions'] = 'More replying options';
